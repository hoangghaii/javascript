...
// poll.displayResults.call({ answers: [5, 3, 9, 6, 1] }, "string");
// poll.displayResults.call({ answers: [5, 2, 3] });

const displayResults = poll.displayResults;
displayResults.call({ answers: [5, 2, 3] }, "string");
displayResults.call({ answers: [5, 3, 9, 6, 1] }, "string");
displayResults.call({ answers: [5, 3, 9, 6, 1] });
